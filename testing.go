...
func newTesting(rootSDK *Deck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Testing {
	return &Testing{
		rootSDK:          rootSDK,
...
// GetTestAPIKeys - Test your API keys
// Verifies that your Deck credentials are valid.
func (s *Testing) GetTestAPIKeys(ctx context.Context, opts ...operations.Option) (*operations.GetTestAPIKeysResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/test/api_keys")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get_/test/api_keys",
		OAuth2Scopes:     nil,
	...
	res := &operations.GetTestAPIKeysResponse{
