...
func newAuthSDK(rootSDK *Deck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AuthSDK {
	return &AuthSDK{
		rootSDK:          rootSDK,
...
// CreateToken - Create an SDK Token
// Generates a short-lived SDK token used to initialize the Auth SDK. The token expires after 20 minutes.
func (s *AuthSDK) CreateToken(ctx context.Context, request *components.LinkTokenCreateRequest, opts ...operations.Option) (*operations.PostLinkTokenCreateResponse, error) {
