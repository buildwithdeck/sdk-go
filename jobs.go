...
func (s *Jobs) Submit(ctx context.Context, xDeckSandbox *string, requestBody *operations.PostJobsSubmitRequestBody, opts ...operations.Option) (*operations.PostJobsSubmitResponse, error) {
...
// GetJobsJobIDStatus - Get Job Status
