...
func newSources(rootSDK *Deck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Sources {
	return &Sources{
		rootSDK:          rootSDK,
...
func (s *Sources) SearchSources(ctx context.Context, request *components.LinkSourcesRequest, opts ...operations.Option) (*operations.PostLinkSourcesResponse, error) {
