...
func newTest(rootSDK *Deck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Test {
	return &Test{
		rootSDK:          rootSDK,
...
func (s *Test) GetTestAPIKeys(ctx context.Context, opts ...operations.Option) (*operations.GetTestAPIKeysResponse, error) {
