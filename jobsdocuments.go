...
type JobsDocuments struct {
	rootSDK          *Deck
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newJobsDocuments(rootSDK *Deck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *JobsDocuments {
...
func (s *JobsDocuments) List(ctx context.Context, jobGUID *string, accessTokenRequest *components.AccessTokenRequest, opts ...operations.Option) (*operations.PostJobsDocumentsListResponse, error) {
	request := operations.PostJobsDocumentsListRequest{
		JobGUID:            jobGUID,
	...
	opURL, err := url.JoinPath(baseURL, "/jobs/documents/list")
	if err != nil {
	...
	res := &operations.PostJobsDocumentsListResponse{
