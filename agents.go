...
func newAgents(rootSDK *Deck, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Agents {
	return &Agents{
		rootSDK:          rootSDK,
...
// PostAgentsPrepare - Prepares an agent in the background so that it is ready for a subsequent ensure connection job request.
func (s *Agents) PostAgentsPrepare(ctx context.Context, request *components.PrepareAgentRequest, opts ...operations.Option) (*operations.PostAgentsPrepareResponse, error) {
